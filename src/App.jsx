  ...
  return (
    <>
      <main className='relative bg-darkCyan overflow-hidden w-full h-screen flex justify-center items-center'>
        ...
        <section className='w-[400px] bg-white z-50 rounded-lg'>
          ...
          <div className='w-full flex flex-col items-center pb-4'>
              ...
              <h1 className='text-black text-xl font-bold'>Victor Crest <span className='text-darkGray font-medium'>26</span></h1>
              ...
              <div className="w-full py-4 flex justify-around border-t border-darkGrayish">
                ...
                <div className='text-center'>
                  <h1 className='text-black text-xl font-bold'>80K</h1>
                  <p className='text-darkGray font-medium'>Followers</p>
                </div>

                <div className='text-center'>
                  <h1 className='text-black text-xl font-bold'>803K</h1>
                  <p className='text-darkGray font-medium'>Likes</p>
                </div>

                <div className='text-center'>
                  <h1 className='text-black text-xl font-bold'>1.4K</h1>
